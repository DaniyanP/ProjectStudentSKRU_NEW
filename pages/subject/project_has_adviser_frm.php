...
$(document).ready(function(){
    ...
    <option value='<?php echo $results2["t_id"];?>'>      <?php echo $results2['t_name']; ?></option><?php } ?></td>";
                        ...
                        tr = tr + "<td><select class='form-select' name='txtAdviserStatus"+rows+"' id='txtAdviserStatus"+rows+"'><option value='1'>อาจารย์ที่ปรึกษาหลัก</option> <option value='2'>อาจารย์ที่ปรึกษาร่วม</option></td>";
...
<body>
    ...
    <main class="content">
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="../subject"><span class="fas fa-home"></span></a></li>
                                ...
                                <li class="breadcrumb-item"><a href="#">ข้อมูลโครงงาน</a></li>
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">จัดการข้อมูลอาจารย์ที่ปรึกษาโครงงาน</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Navbar links -->
        ...
        <div class="py-0">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">บันทึกข้อมูลการเป็นที่ปรึกษาโครงงานนักศึกษา</h1>
        ...
        <div class="card border-light shadow-sm mb-4">
            <div class="card-body">
            <center>
            <form action="project_has_adviser_save.php" id="frmMain" name="frmMain" method="post">
...
<thead>
  <tr>
    ...
    <td width="200"> <div align="center"><h6>อาจารย์ที่ปรึกษา</h6></div></td>
    <td width="150"> <div align="center"><h6>สถานะอาจารย์ที่ปรึกษา</h6></div></td>
