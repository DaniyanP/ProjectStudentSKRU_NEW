        ...
        <div class="card border-light shadow-sm mb-4">
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                    <div class="mt-3">
            <button type="submit" class="btn btn-primary" name="AdminAdd">บันทึก</button>
...
$teacher_lastname  = $_POST['teacher_lastname'];
    ...
    $set_permission = 3;
     ...
     $sql = "INSERT INTO teacher
            (teacher_id, teacher_name, teacher_email, teacher_password,teacher_type, teacher_title, teacher_lastname)
            
             VALUES
            ('$teacher_id', '$teacher_name', '$teacher_email', '$teacher_password','$set_permission', '$teacher_title', '$teacher_lastname') "; 
